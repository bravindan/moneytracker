...
import { addInvestment, getInvestments, updateInvestment, deleteInvestment, getMonthlySummary } from '../services/firestoreService';
...
const AddInvestmentScreen = ({ navigation }) => {
  ...
  const renderInvestment = ({ item }) => (
    <View style={[styles.investmentItem, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}>
      <View style={styles.investmentInfo}>
        <View style={styles.investmentHeader}>
          <Text style={[styles.platformName, { color: theme.colors.text }]}>{item.category}</Text>
          <Text style={[styles.platformName, { color: theme.colors.text }]}>• {item.platform}</Text>
        ...
        <View style={styles.investmentDetails}>
          <Text style={[styles.percentageText, { color: theme.colors.textSecondary }]}>
            {getInvestmentPercentage(item.amount)}% of allocated
          </Text>
          {item.description && (
            <Text style={[styles.investmentDescription, { color: theme.colors.textSecondary }]}>
              {item.description}
            </Text>
          )}
        </View>
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background, paddingTop: insets.top }]}>
      ...
      <View style={styles.headerContainer}>
        ...
        <Text style={[styles.headerTitle, { color: theme.colors.text }]}>Add Investments</Text>
        ...
        >
          ...
          <View style={[styles.formContainer, { backgroundColor: theme.colors.card }]}>
            ...
            <View style={[styles.allocatedAmountContainer, { backgroundColor: theme.colors.background, borderColor: theme.colors.border }]}>
              <Text style={[styles.allocatedAmountLabel, { color: theme.colors.textSecondary }]}>Allocated Amount</Text>
            ...
            <View style={styles.inputGroup}>
              ...
              {showCategoryDropdown && (
                <View style={[styles.dropdownContainer, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}>
                  <ScrollView 
                  ...
                  >
                    {categories.map((cat) => (
                      ...
                      >
                        <Text style={[styles.dropdownItemText, { color: theme.colors.text }]}>{cat}</Text>
                      </TouchableOpacity>
                    ))}
                  </ScrollView>
                </View>
            ...
            <View style={styles.inputGroup}>
              <Text style={[styles.label, { color: theme.colors.textSecondary }]}>Amount (KES) *</Text>
              <TextInput
                style={[styles.input, { backgroundColor: theme.colors.background, borderColor: theme.colors.border, color: theme.colors.text }]}
            ...
            <View style={styles.listContainer}>
              <View style={styles.listHeader}>
                ...
                <Text style={[styles.totalAmount, { color: theme.colors.text }]}>
                  Total: KES {totalInvested.toLocaleString()}
                </Text>
              </View>
              ...
              >
                <Text style={styles.clearButtonText}>Clear All Investments</Text>
              </TouchableOpacity>
            </View>
          )}
        </ScrollView>
